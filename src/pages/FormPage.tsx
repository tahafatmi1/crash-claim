...
//       <Input name="injuries" value={formData.injuries} onChange={handleInputChange} />
...
//       <Select value={formData.had_medical_treatment_within_14_days_of_accident} onValueChange={v => handleSelectChange('had_medical_treatment_within_14_days_of_accident', v)}>
//         <SelectTrigger><SelectValue /></SelectTrigger>
//         <SelectContent>
...
//       <Select value={formData.has_ongoing_medical_treatment_once_a_month_at_least} onValueChange={v => handleSelectChange('has_ongoing_medical_treatment_once_a_month_at_least', v)}>
//         <SelectTrigger><SelectValue /></SelectTrigger>
//         <SelectContent>
//           <SelectItem value="true">Yes</SelectItem>
//           <SelectItem value="false">No</SelectItem>
